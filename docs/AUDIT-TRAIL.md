...
## Stage 15 — first upstream consumer fixes

The first real consumer application running LombokClarion on live production
work exercised the framework end-to-end and reported nine targeted hazards and
gaps. All nine are now closed:
